...
<style type="text/css">
 ...
 .view{
 background-image: url("images/view_student.png");
 background-size: cover;
 background-repeat: no-repeat;
 }
</style>
...
<img src="images/student_management_logo.png" width="100px" height="50px">
<div class="pt-2">
<a href="#enroll">
        ...
        <tbody> 
         ...
         <c:forEach items="${data}" var="s"> 
          <tr> 
           ...
           <div class="btn-group btn-group-sm" role="group" aria
label="..."> 
